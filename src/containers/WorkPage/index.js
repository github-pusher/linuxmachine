      ...
      <Content>
        <Card>
          <Video
            ...
            poster="https://res.cloudinary.com/linuxmachinecloud/image/upload/c_scale,w_720/v1678334160/linuxmachine/posters/xk9bwvzs0lcmwmfstkhw.png"
            preload="none"
            controls={true}
            loop={true}
        ...
        <Card>
          <Video
            ...
            poster="https://res.cloudinary.com/linuxmachinecloud/image/upload/c_scale,w_512/v1670586806/linuxmachine/posters/yys7izia97sjkvnasckb.png"
            preload="none"
            controls={true}
            loop={true}
            onMouseOver={(e) => {handleMouseOver(e)}}
          ...
          <CardButtons>
            <A target="_blank" href="https://codepen.io/marathaziev/full/QWrLgaR">{t.workButton}</A>
          </CardButtons>
        </Card>
      </Content>
    </Wrapper>
